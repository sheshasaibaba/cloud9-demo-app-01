...
import HeroImage from '../assets/istockphoto-1635990876-612x612.jpg'
  ...
  return (
    <div className='bg-black text-white text-center py-16'>
        ...
        <h1 className='text-4xl font-bold'>
            I'm {" "}
            <span className='text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500'>Sheshasaibaba</span>
